// ═══════════════════════════════════════════
//  Springer (LNCS) — Double-Column Template
// ═══════════════════════════════════════════
  ...
  align(center)[
    ...
    #grid(
      ...
      ..data.authors.map(a => align(center)[
        #text(size: 9pt)[#eval(a.name, mode: "markup")] \
        #text(size: 8pt, style: "italic")[#eval(a.affiliation, mode: "markup")]
      ])
    )
  ]
  v(2em)
